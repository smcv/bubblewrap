  ...
  for (op = ops; op != NULL; op = op->next)
    {
      ...
      if (op->dest &&
          (op->flags & NO_CREATE_DEST) == 0)
        {
          ...
          /* If we're creating a file as 0600 or 0700, also create
           * parents as 0700, and if we're creating a file as 0640 or 0750,
           * create parents as 0750. */
